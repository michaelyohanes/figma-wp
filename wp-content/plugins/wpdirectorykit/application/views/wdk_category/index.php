        ...
        <table class="wp-list-table widefat fixed striped table-view-list pages">
            ...
            <?php foreach ( $categories as $category ):?>
                <tr>
                    ...
                    <td>
                        <?php echo str_pad('', wmvc_show_data('level', $category, 0)*12, '&nbsp;').'|-'; ?><a href="<?php echo esc_url(get_admin_url() . "admin.php?page=wdk_category&function=edit&id=".wmvc_show_data('idcategory', $category, '-')); ?>"><?php echo esc_html(strip_tags(wmvc_show_data('category_title', $category, '-'))).' #'.esc_html(wmvc_show_data('idcategory', $category, '-')); ?></a>
                    </td>
                    <td>
