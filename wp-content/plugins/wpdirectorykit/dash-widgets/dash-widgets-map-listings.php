...
class WDK_Dashboard_Widget_Map_Listings extends WDK_DashWidgets {
    ...
    public static function widget() {
        ...
        $data['results'] = $WMVC->listing_m->get_pagination($data['settings']['conf_limit'], NULL, array('is_activated' => 1,'is_approved'=>1,'('.$WMVC->listing_m->_table_name.'.lat NOT LIKE "0%" and '.$WMVC->listing_m->_table_name.'.lng NOT LIKE "0%")' => NULL), TRUE);
