...
$addtohos_dbusers =  get_users( array( 'search' => '',
                                    'orderby' => 'display_name', 'order' => 'ASC'));

$addtohos_users = array();
foreach($addtohos_dbusers as $addtohos_dbuser) {
    $addtohos_users[wmvc_show_data('ID', $addtohos_dbuser)] = '#'.wmvc_show_data('ID', $addtohos_dbuser).', '.wmvc_show_data('display_name', $addtohos_dbuser);
}
    ...
    <div class="addtohos-field-container">
        ...
        echo esc_html(
            wmvc_show_data(
                $addtohos_field_id,
                'user_m',
                wmvc_show_data($addtohos_field_id, $db_data, ''),
                'display_name',
                '',
                __('Not Selected', 'add-to-home-screen-on-ios-pwa')
            )
        );
        ?>
