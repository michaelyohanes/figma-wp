    ...
    <div class="addtohos-field-container">
        <fieldset>
            ...
            <?php foreach($field->values as $addtohos_field_key => $addtohos_field_value): ?>
                <input name="<?php echo esc_attr($addtohos_field_id); ?>" type="radio" id="<?php echo esc_attr($addtohos_field_id); ?>_<?php echo esc_attr($addtohos_field_key); ?>" value="<?php echo esc_attr($addtohos_field_key); ?>" <?php echo !empty(wmvc_show_data($addtohos_field_id, $db_data, '') == $addtohos_field_key)?'checked':''; ?>>
                <label for="<?php echo esc_attr($addtohos_field_id); ?>_<?php echo esc_attr($addtohos_field_key); ?>"><?php echo esc_html($addtohos_field_value); ?></label>
            <?php endforeach; ?>
        </fieldset>
