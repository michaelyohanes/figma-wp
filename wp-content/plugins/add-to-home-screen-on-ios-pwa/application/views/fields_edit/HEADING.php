...
<div class="addtohos-field-edit <?php echo esc_attr($field->field_type); ?> addtohos-col-<?php echo esc_attr($field->columns_number); ?> <?php echo esc_attr($field->class); ?>">
    <label for="<?php echo esc_attr($addtohos_field_id); ?>" class="<?php if(empty($field->hint)):?> w100 <?php endif;?>"><h3><?php echo esc_html($addtohos_field_label).esc_html($addtohos_required); ?></h3></label>
