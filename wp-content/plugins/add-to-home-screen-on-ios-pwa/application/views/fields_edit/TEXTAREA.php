...
$addtohos_value = wmvc_show_data(esc_attr($addtohos_field_id), $db_data, '');

if(empty($addtohos_value))
{
    $addtohos_value = $addtohos_default;
}
?>
...
<div class="addtohos-field-edit <?php echo esc_attr($field->field_type); ?> addtohos-col-<?php echo esc_attr($field->columns_number); ?> <?php echo esc_attr($field->class); ?>">
    ...
    <div class="addtohos-field-container">
        <?php 
            wp_editor(wp_kses_post($addtohos_value), esc_attr($addtohos_field_id), array (
                    'textarea_rows' => 5,
                    'media_buttons' => FALSE,
                    'wpautop' => false,
                    'teeny'         => false,
