...
class Addtohos {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Addtohos_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'ADDTOHOS_VERSION' ) ) {
			$this->version = ADDTOHOS_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'add-to-home-screen-on-ios-pwa';
	 ...
	 *
	 * - Addtohos_Loader. Orchestrates the hooks of the plugin.
	 * - Addtohos_i18n. Defines internationalization functionality.
	 * - Addtohos_Admin. Defines all hooks for the admin area.
	 * - Addtohos_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-addtohos-loader.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-addtohos-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
        require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-addtohos-public.php';
		...
		$this->loader = new Addtohos_Loader();
		//global $Winter_MVC;
    ...
    private function load_frameworks()
    {
        ...
        {
            $Addtohos_Winter_MVC->plugin_directory = plugin_dir_path( __FILE__ ).'../';
        }
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Addtohos_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Addtohos_Public( $this->get_plugin_name(), $this->get_version() );
        ...
        $this->loader->add_action(
			'wp_ajax_addtohos_public_action',
			$plugin_public,
			'ajax_public'
		);
		
        $this->loader->add_action(
			'wp_ajax_nopriv_addtohos_public_action',
			$plugin_public,
			'ajax_public'
		);
	}
	 ...
	 *
	 * @since     1.0.0
	 * @return    Addtohos_Loader    Orchestrates the hooks of the plugin.
	 */
	...
	{
		require_once  plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-addtohos-activator.php';

        $this->loader->add_action( 'plugins_loaded', 'Addtohos_Activator', 'plugins_loaded' );
