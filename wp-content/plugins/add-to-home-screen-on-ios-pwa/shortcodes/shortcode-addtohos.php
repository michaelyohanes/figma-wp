...
/*
* Widget [addtohos_ios_add_to_home_screen_button]
* atts list:
*
*/

add_shortcode('addtohos_ios_add_to_home_screen_button', function ($atts, $content){
    $atts = shortcode_atts(array(
        'id'=>NULL,
        'button_text'=> esc_html__('Add To Home Screen', 'add-to-home-screen-on-ios-pwa'),
        'custom_class'=>'',
    ), $atts);
