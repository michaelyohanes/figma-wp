...
<div class="eli_f_group checkbox eli_f_group_el_<?php echo esc_attr($element['_id']); ?>" style="<?php echo esc_attr($styles); ?>">
    ...
    <label for="<?php echo esc_attr($field_id); ?>">
        ...
        <?php if (!empty($element['field_link_text'])) : ?>
            <a class="accept_link"
               href="<?php echo esc_url($element['link']['url']); ?>"
               <?php echo !empty($element['link']['is_external']) ? 'target="_blank" rel="noopener noreferrer"' : ''; ?>>
                <?php echo esc_html($element['field_link_text']); ?>
            </a>
        <?php endif; ?>
