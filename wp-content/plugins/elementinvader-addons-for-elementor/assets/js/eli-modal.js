    ...
    <div class="modal-dialog modal-notice">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><?php echo esc_html__('How Add Link Calendar Into Google?', 'elementinvader-addons-for-elementor'); ?>
                </h5>
            ...
            <div class="modal-body">
              <div class="instruction">
                  <h4><strong><?php echo esc_html__('1. Open Settings On Google Calendar', 'elementinvader-addons-for-elementor'); ?></strong>
                  </h4>
                  <br>
              ...
              <br>
              <div class="instruction">
                  <h4><strong><?php echo esc_html__('2. Copy Past Event Link', 'elementinvader-addons-for-elementor'); ?></strong></h4>
                  <p class="description">
        ...
        <div class="modal-footer justify-content-center">
            <button type="button" class="button button-secondary"
                data-eli-dismiss="modal"><?php echo esc_html__('Close', 'elementinvader-addons-for-elementor'); ?></button>
        </div>
    </div>
</div>
